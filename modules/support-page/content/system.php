...
<ul class="itsec-support">
	<li>
		...
		<ul>
			<li><?php _e( 'Public IP Address', 'ithemes-security' ); ?>: <strong><a target="_blank" title="<?php _e( 'Get more information on this address', 'ithemes-security' ); ?>" href="http://whois.domaintools.com/<?php echo $itsec_lib->get_ip(); ?>"><?php echo $itsec_lib->get_ip(); ?></a></strong></li>
			<li><?php _e( 'User Agent', 'ithemes-security' ); ?>: <strong><?php echo filter_var( $_SERVER['HTTP_USER_AGENT'], FILTER_SANITIZE_STRING ); ?></strong></li>
		</ul>
	</li>
	...
	<li>
		...
		<ul>
			<li><?php _e( 'Website Root Folder', 'ithemes-security' ); ?>: <strong><?php echo get_site_url(); ?></strong></li>
			<li><?php _e( 'Document Root Path', 'ithemes-security' ); ?>: <strong><?php echo filter_var( $_SERVER['DOCUMENT_ROOT'], FILTER_SANITIZE_STRING ); ?></strong></li>
			<?php 
			...
			?>
			<li><?php _e( '.htaccess File is Writable', 'ithemes-security' ); ?>: <strong><?php echo $copen . $htaw . $cclose; ?></strong></li>
			<?php 
			...
			?>
			<li><?php _e( 'wp-config.php File is Writable', 'ithemes-security' ); ?>: <strong><?php echo $copen . $wconf . $cclose; ?></strong></li>
		</ul>
	</li>
	...
	<li>
		...
		<ul>
			<li><?php _e( 'MySQL Database Version', 'ithemes-security' ); ?>: <?php $sqlversion = $wpdb->get_var( "SELECT VERSION() AS version" ); ?><strong><?php echo $sqlversion; ?></strong></li>
			<li><?php _e( 'MySQL Client Version', 'ithemes-security' ); ?>: <strong><?php echo mysql_get_client_info(); ?></strong></li>
			...
			<?php $mysqlinfo = $wpdb->get_results( "SHOW VARIABLES LIKE 'sql_mode'" );
				...
				if ( empty( $sql_mode ) ) $sql_mode = __( 'Not Set', 'ithemes-security' );
	...
	<li>
		...
		<ul>
			<li><?php _e( 'Server / Website IP Address', 'ithemes-security' ); ?>: <strong><a target="_blank" title="<?php _e( 'Get more information on this address', 'ithemes-security' ); ?>" href="http://whois.domaintools.com/<?php echo $server_addr; ?>"><?php echo $server_addr; ?></a></strong></li>
				<li><?php _e( 'Server Type', 'ithemes-security' ); ?>: <strong><?php echo filter_var( filter_var( $_SERVER['SERVER_SOFTWARE'], FILTER_SANITIZE_STRING ), FILTER_SANITIZE_STRING ); ?></strong></li>
				<li><?php _e( 'Operating System', 'ithemes-security' ); ?>: <strong><?php echo PHP_OS; ?></strong></li>
				<li><?php _e( 'Browser Compression Supported', 'ithemes-security' ); ?>: <strong><?php echo filter_var( $_SERVER['HTTP_ACCEPT_ENCODING'], FILTER_SANITIZE_STRING ); ?></strong></li>
		</ul>
	</li>
	...
	<li>
		...
		<ul>
			...
			<li><?php _e( 'PHP Memory Usage', 'ithemes-security' ); ?>: <strong><?php echo round(memory_get_usage() / 1024 / 1024, 2) . __( ' MB', 'ithemes-security' ); ?></strong> </li>
			<?php 
			...
			?>
			<li><?php _e( 'PHP Allow URL fopen', 'ithemes-security' ); ?>: <strong><?php echo $allow_url_fopen; ?></strong></li>
			<?php 
			...
			?>
			<li><?php _e( 'PHP Display Errors', 'ithemes-security' ); ?>: <strong><?php echo $display_errors; ?></strong></li>
			<?php 
			...
			?>
			<li><?php _e( 'PHP Display Startup Errors', 'ithemes-security' ); ?>: <strong><?php echo $display_startup_errors; ?></strong></li>
			<?php 
			...
			?>
			<li><?php _e( 'PHP Register Globals', 'ithemes-security' ); ?>: <strong><?php echo $register_globals; ?></strong></li>
			<?php 
			...
			?>
			<li><?php _e( 'PHP Magic Quotes GPC', 'ithemes-security' ); ?>: <strong><?php echo $magic_quotes_gpc; ?></strong></li>
			<?php 
	...
	<li>
		...
		<ul>
			...
			?>
			<li><?php _e( 'WP Permalink Structure', 'ithemes-security' ); ?>: <strong> <?php echo $copen . $permalink_structure . $cclose; ?></strong></li>
