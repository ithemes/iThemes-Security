...
if ( ! class_exists( 'BWPS_Away_Mode_Admin' ) ) {
	...
	class BWPS_Away_Mode_Admin {
		 ...
		 * @param BWPS_Away_Mode $module Instance of the away mode module class
		 *
		 * @return BWPS_Away_Mode_Admin              The instance of the BWPS_Away_Mode_Admin class
		 */
