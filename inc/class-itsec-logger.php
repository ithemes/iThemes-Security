...
if ( ! class_exists( 'ITSEC_Logger' ) ) {
	...
	final class ITSEC_Logger {
		...
		public function add_module_intro( $screen ) {
			...
			$content = '<p>' . __( 'Below are the various logs generated by this plugin. To change how long log items are retained please visit the general settings.', 'ithemes-security' ) . '</p>';
			echo $content;
